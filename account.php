    ...
    <div class="container mt-4">
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          <center>
            <div class="card" style="max-width: 70%; position: relative;">
              <img class="card-img-top" src="https://www.w3schools.com/bootstrap4/img_avatar1.png" alt="Card image">
              <button class="btn btn-circle btn-xl" style="position: absolute; top: 60%; right: 10%" onclick="fileModal()">+</button>
              <div class="card-body">
                <h4 class="card-title">
